    ...
    <div className="bg-white p-8 rounded-[2.5rem] shadow-2xl border border-slate-100 max-w-md w-full mx-auto relative overflow-hidden">
      ...
      {step === 1 && (
        <>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <Button
              type="submit"
              className="w-full h-14 rounded-2xl text-lg font-black uppercase tracking-wider"
              size="lg"
      ...
      {step === 3 && (
        <div className="text-center space-y-8 py-10 animate-in fade-in zoom-in duration-500">
          ...
          <Button 
            className="w-full h-14 rounded-2xl font-black bg-emerald-500 hover:bg-emerald-600 shadow-lg shadow-emerald-200" 
            onClick={() => setStep(1)}
          >
            Done
          </Button>
