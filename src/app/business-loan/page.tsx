...
export const metadata: Metadata = {
  title: "Business Loan | Collateral Free MSME Loans Up to ₹75 Lakhs | Techstar Money Solution",
  description: "Get an unsecured business loan with Techstar Money Solution. 100% paperless process, competitive interest rates starting from 14% p.a., and flexible tenure for MSMEs and startups in India.",
