...
const STATUS_LABELS: Record<string, string> = {
  'Disbursement Approval Pending': 'Disbursal In Review',
}

const partnerStatusLabel = (status?: string) => STATUS_LABELS[status || ''] || status || 'New Lead'
                    ...
                    <div className="flex flex-col items-end justify-center gap-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className={`px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-widest border ${STATUS_COLORS[lead.status] || 'bg-slate-50 text-slate-400'}`}>
                          {partnerStatusLabel(lead.status)}
                        </span>
                      </div>
