...
const comparisonData = {
  personal: [
    { bank: "HDFC Bank", logo: "https://upload.wikimedia.org/wikipedia/commons/f/f0/HDFC-Bank-Logo.svg", rate: "10.50% - 14.50%", fee: "0.5% - 2.0%", speed: "4 Hours", docs: "Minimal", disbursal: "24 Hours" },
    ...
    { bank: "SBI", logo: "https://upload.wikimedia.org/wikipedia/commons/c/cc/State_Bank_of_India.svg", rate: "11.00% - 13.50%", fee: "Up to 1.5%", speed: "3 Days", docs: "Standard", disbursal: "4 Days" },
  ...
  home: [
    { bank: "HDFC Bank", logo: "https://upload.wikimedia.org/wikipedia/commons/f/f0/HDFC-Bank-Logo.svg", rate: "8.50% - 9.15%", fee: "0.5% or ₹3,000", speed: "4 Days", docs: "Standard", disbursal: "5 Days" },
    ...
    { bank: "SBI", logo: "https://upload.wikimedia.org/wikipedia/commons/c/cc/State_Bank_of_India.svg", rate: "8.50% - 9.05%", fee: "Nil - 0.35%", speed: "6 Days", docs: "Detailed", disbursal: "7 Days" },
  ...
  business: [
    { bank: "HDFC Bank", logo: "https://upload.wikimedia.org/wikipedia/commons/f/f0/HDFC-Bank-Logo.svg", rate: "15.00% - 19.00%", fee: "Up to 2.5%", speed: "48 Hours", docs: "Standard", disbursal: "3 Days" },
    ...
    { bank: "SBI", logo: "https://upload.wikimedia.org/wikipedia/commons/c/cc/State_Bank_of_India.svg", rate: "11.20% - 14.50%", fee: "Up to 1.5%", speed: "5 Days", docs: "Detailed", disbursal: "6 Days" },
